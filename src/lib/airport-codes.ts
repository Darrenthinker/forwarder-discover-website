...
export const airportCodes: { [key: string]: AirportInfo } = {
  ...
  'HOU': { chinese: '休斯顿霍比', english: 'Houston Hobby', country: '美国' },
  'DEN': { chinese: '丹佛', english: 'Denver', country: '美国' },
  'PHX': { chinese: '凤凰城', english: 'Phoenix', country: '美国' },
  'LAS': { chinese: '拉斯维加斯', english: 'Las Vegas', country: '美国' },
  'SEA': { chinese: '西雅图', english: 'Seattle', country: '美国' },
  'PDX': { chinese: '波特兰', english: 'Portland', country: '美国' },
  ...
  'DCA': { chinese: '华盛顿里根', english: 'Washington Reagan', country: '美国' },
  ...
  'STL': { chinese: '圣路易斯', english: 'St. Louis', country: '美国' },
  'MSY': { chinese: '新奥尔良', english: 'New Orleans', country: '美国' },
  'PHL': { chinese: '费城', english: 'Philadelphia', country: '美国' },
  'PIT': { chinese: '匹兹堡', english: 'Pittsburgh', country: '美国' },
  'CVG': { chinese: '辛辛那提', english: 'Cincinnati', country: '美国' },
  'CLE': { chinese: '克利夫兰', english: 'Cleveland', country: '美国' },
  'MKE': { chinese: '密尔沃基', english: 'Milwaukee', country: '美国' },
  ...
  'AUS': { chinese: '奥斯汀', english: 'Austin', country: '美国' },
  ...
  'BUR': { chinese: '伯班克', english: 'Burbank', country: '美国' },
  'SNA': { chinese: '橙县', english: 'Orange County', country: '美国' },
  'HNL': { chinese: '檀香山', english: 'Honolulu', country: '美国' },
  'ANC': { chinese: '安克雷奇', english: 'Anchorage', country: '美国' },

  // 加拿大主要国际机场
  'YYZ': { chinese: '多伦多', english: 'Toronto Pearson', country: '加拿大' },
  ...
  'YWG': { chinese: '温尼伯', english: 'Winnipeg', country: '加拿大' },
  'YOW': { chinese: '渥太华', english: 'Ottawa', country: '加拿大' },
  'YHZ': { chinese: '哈利法克斯', english: 'Halifax', country: '加拿大' },
  'YQB': { chinese: '魁北克城', english: 'Quebec City', country: '加拿大' },

  // 墨西哥主要国际机场
  'MEX': { chinese: '墨西哥城', english: 'Mexico City', country: '墨西哥' },
  'CUN': { chinese: '坎昆', english: 'Cancun', country: '墨西哥' },
  'GDL': { chinese: '瓜达拉哈拉', english: 'Guadalajara', country: '墨西哥' },
  'MTY': { chinese: '蒙特雷', english: 'Monterrey', country: '墨西哥' },
  'TIJ': { chinese: '蒂华纳', english: 'Tijuana', country: '墨西哥' },
  'PVR': { chinese: '巴亚尔塔港', english: 'Puerto Vallarta', country: '墨西哥' },
  'SJD': { chinese: '洛斯卡波斯', english: 'Los Cabos', country: '墨西哥' },
  'MZT': { chinese: '马萨特兰', english: 'Mazatlan', country: '墨西哥' },
  ...
  'GCM': { chinese: '黄金海岸', english: 'Gold Coast', country: '澳大利亚' },
  ...
  'SUV': { chinese: '苏瓦', english: 'Suva', country: '斐济' },
  'APW': { chinese: '阿皮亚', english: 'Apia', country: '萨摩亚' },
  'NOU': { chinese: '努美阿', english: 'Noumea', country: '新喀里多尼亚' },
  'PPT': { chinese: '帕皮提', english: 'Papeete', country: '法属波利尼西亚' },

  // 亚洲其他国家补充
  // 印尼其他机场
  'DPS': { chinese: '巴厘岛', english: 'Bali', country: '印尼' },
  'SUB': { chinese: '泗水', english: 'Surabaya', country: '印尼' },
  'MDN': { chinese: '棉兰', english: 'Medan', country: '印尼' },
  'UPG': { chinese: '望加锡', english: 'Makassar', country: '印尼' },
  ...
  'HHQ': { chinese: '华欣', english: 'Hua Hin', country: '泰国' },
  'USM': { chinese: '苏梅', english: 'Koh Samui', country: '泰国' },

  // 菲律宾其他机场
  'CEB': { chinese: '宿务', english: 'Cebu', country: '菲律宾' },
  'DVO': { chinese: '达沃', english: 'Davao', country: '菲律宾' },
  ...
  // 东帝汶
  'DIL': { chinese: '帝力尼古劳·洛巴托总统国际机场', english: 'Presidente Nicolau Lobato International Airport', country: '东帝汶', type: 'international' },
  'AUT': { chinese: '阿陶罗机场', english: 'Atauro Airport', country: '东帝汶', type: 'domestic' },
  'BCH': { chinese: '包考机场', english: 'Baucau Airport', country: '东帝汶', type: 'domestic' },
  'UNI': { chinese: '马洛玛机场', english: 'Maliana Airport', country: '东帝汶', type: 'domestic' },
  ...
  'LPL': { chinese: '利物浦', english: 'Liverpool', country: '英国' },
  'BFS': { chinese: '贝尔法斯特', english: 'Belfast', country: '英国' },

  // 德国其他机场
  'TXL': { chinese: '柏林泰格尔', english: 'Berlin Tegel', country: '德国' },
  'BER': { chinese: '柏林勃兰登堡', english: 'Berlin Brandenburg', country: '德国' },
  'CGN': { chinese: '科隆', english: 'Cologne', country: '德国' },
  'STR': { chinese: '斯图加特', english: 'Stuttgart', country: '德国' },
  'NUE': { chinese: '纽伦堡', english: 'Nuremberg', country: '德国' },
  'HAJ': { chinese: '汉诺威', english: 'Hannover', country: '德国' },
  'LEJ': { chinese: '莱比锡', english: 'Leipzig', country: '德国' },
  'DRS': { chinese: '德累斯顿', english: 'Dresden', country: '德国' },

  // 法国其他机场
  'NCE': { chinese: '尼斯', english: 'Nice', country: '法国' },
  'LYS': { chinese: '里昂', english: 'Lyon', country: '法国' },
  'MRS': { chinese: '马赛', english: 'Marseille', country: '法国' },
  'TLS': { chinese: '图卢兹', english: 'Toulouse', country: '法国' },
  'BOD': { chinese: '波尔多', english: 'Bordeaux', country: '法国' },
  'NTE': { chinese: '南特', english: 'Nantes', country: '法国' },
  'LIL': { chinese: '里尔', english: 'Lille', country: '法国' },
  'SXB': { chinese: '斯特拉斯堡', english: 'Strasbourg', country: '法国' },

  // 意大利其他机场
  'VCE': { chinese: '威尼斯', english: 'Venice', country: '意大利' },
  'NAP': { chinese: '那不勒斯', english: 'Naples', country: '意大利' },
  'BLQ': { chinese: '博洛尼亚', english: 'Bologna', country: '意大利' },
  'FLR': { chinese: '佛罗伦萨', english: 'Florence', country: '意大利' },
  'PSA': { chinese: '比萨', english: 'Pisa', country: '意大利' },
  'TRN': { chinese: '都灵', english: 'Turin', country: '意大利' },
  'CTA': { chinese: '卡塔尼亚', english: 'Catania', country: '意大利' },
  'PMO': { chinese: '巴勒莫', english: 'Palermo', country: '意大利' },
  'CAG': { chinese: '卡利亚里', english: 'Cagliari', country: '意大利' },

  // 西班牙其他机场
  'AGP': { chinese: '马拉加', english: 'Malaga', country: '西班牙' },
  'SVQ': { chinese: '塞维利亚', english: 'Seville', country: '西班牙' },
  ...
  'LPA': { chinese: '拉斯帕尔马斯', english: 'Las Palmas', country: '西班牙' },
  'TFS': { chinese: '特内里费', english: 'Tenerife', country: '西班牙' },
  'PMI': { chinese: '帕尔马', english: 'Palma', country: '西班牙' },
  'IBZ': { chinese: '伊维萨', english: 'Ibiza', country: '西班牙' },

  // 葡萄牙
  'LIS': { chinese: '里斯本', english: 'Lisbon', country: '葡萄牙' },
  'OPO': { chinese: '波尔图', english: 'Porto', country: '葡萄牙' },
  'FAO': { chinese: '法鲁', english: 'Faro', country: '葡萄牙' },
  'FNC': { chinese: '丰沙尔', english: 'Funchal', country: '葡萄牙' },

  // 北欧其他机场
  'GOT': { chinese: '哥德堡', english: 'Gothenburg', country: '瑞典' },
  'MMX': { chinese: '马尔默', english: 'Malmo', country: '瑞典' },
  'BGO': { chinese: '卑尔根', english: 'Bergen', country: '挪威' },
  'TRD': { chinese: '特隆赫姆', english: 'Trondheim', country: '挪威' },
  'TRF': { chinese: '桑德尔福德', english: 'Sandefjord', country: '挪威' },
  'TMP': { chinese: '坦佩雷', english: 'Tampere', country: '芬兰' },
  'TKU': { chinese: '图尔库', english: 'Turku', country: '芬兰' },
  'AAL': { chinese: '奥尔堡', english: 'Aalborg', country: '丹麦' },
  'BLL': { chinese: '比隆', english: 'Billund', country: '丹麦' },
  'AAR': { chinese: '奥胡斯', english: 'Aarhus', country: '丹麦' },
  ...
  'LED': { chinese: '圣彼得堡', english: 'St. Petersburg', country: '俄罗斯' },
  'KZN': { chinese: '喀山', english: 'Kazan', country: '俄罗斯' },
  'ROV': { chinese: '罗斯托夫', english: 'Rostov-on-Don', country: '俄罗斯' },
  'YEK': { chinese: '叶卡捷琳堡', english: 'Yekaterinburg', country: '俄罗斯' },
  'OVB': { chinese: '新西伯利亚', english: 'Novosibirsk', country: '俄罗斯' },

  // 乌克兰
  'KBP': { chinese: '基辅', english: 'Kiev', country: '乌克兰' },
  'IEV': { chinese: '基辅茹良', english: 'Kiev Zhulyany', country: '乌克兰' },
  'ODS': { chinese: '敖德萨', english: 'Odessa', country: '乌克兰' },
  'LWO': { chinese: '利沃夫', english: 'Lviv', country: '乌克兰' },

  // 白俄罗斯
  'MSQ': { chinese: '明斯克', english: 'Minsk', country: '白俄罗斯' },

  // 波罗的海国家
  'RIX': { chinese: '里加', english: 'Riga', country: '拉脱维亚' },
  'TLL': { chinese: '塔林', english: 'Tallinn', country: '爱沙尼亚' },
  'VNO': { chinese: '维尔纽斯', english: 'Vilnius', country: '立陶宛' },
  'KUN': { chinese: '考纳斯', english: 'Kaunas', country: '立陶宛' },

  // 巴尔干国家
  'BEG': { chinese: '贝尔格莱德', english: 'Belgrade', country: '塞尔维亚' },
  'ZAG': { chinese: '萨格勒布', english: 'Zagreb', country: '克罗地亚' },
  'SPU': { chinese: '斯普利特', english: 'Split', country: '克罗地亚' },
  'DBV': { chinese: '杜布罗夫尼克', english: 'Dubrovnik', country: '克罗地亚' },
  'LJU': { chinese: '卢布尔雅那', english: 'Ljubljana', country: '斯洛文尼亚' },
  'SJJ': { chinese: '萨拉热窝', english: 'Sarajevo', country: '波黑' },
  'SKP': { chinese: '斯科普里', english: 'Skopje', country: '北马其顿' },
  'TGD': { chinese: '波德戈里察', english: 'Podgorica', country: '黑山' },
  'TIA': { chinese: '地拉那', english: 'Tirana', country: '阿尔巴尼亚' },

  // 罗马尼亚和保加利亚
  'OTP': { chinese: '布加勒斯特', english: 'Bucharest', country: '罗马尼亚' },
  'CLJ': { chinese: '克卢日', english: 'Cluj-Napoca', country: '罗马尼亚' },
  'SOF': { chinese: '索菲亚', english: 'Sofia', country: '保加利亚' },
  ...
  'ALG': { chinese: '阿尔及尔', english: 'Algiers', country: '阿尔及利亚' },
  'CMN': { chinese: '卡萨布兰卡', english: 'Casablanca', country: '摩洛哥' },
  'RAK': { chinese: '马拉喀什', english: 'Marrakech', country: '摩洛哥' },
  'FEZ': { chinese: '非斯', english: 'Fez', country: '摩洛哥' },
  'TUN': { chinese: '突尼斯', english: 'Tunis', country: '突尼斯' },
  'MIR': { chinese: '莫纳斯提尔', english: 'Monastir', country: '突尼斯' },
  'TIP': { chinese: '的黎波里', english: 'Tripoli', country: '利比亚' },
  'BEN': { chinese: '班加西', english: 'Benghazi', country: '利比亚' },

  // 西非
  'LOS': { chinese: '拉各斯', english: 'Lagos', country: '尼日利亚' },
  'ABV': { chinese: '阿布贾', english: 'Abuja', country: '尼日利亚' },
  'KAN': { chinese: '卡诺', english: 'Kano', country: '尼日利亚' },
  'ACC': { chinese: '阿克拉', english: 'Accra', country: '加纳' },
  'ABJ': { chinese: '阿比让', english: 'Abidjan', country: '科特迪瓦' },
  'DKR': { chinese: '达喀尔', english: 'Dakar', country: '塞内加尔' },
  'BAK': { chinese: '巴马科', english: 'Bamako', country: '马里' },
  'OUA': { chinese: '瓦加杜古', english: 'Ouagadougou', country: '布基纳法索' },
  'COO': { chinese: '科托努', english: 'Cotonou', country: '贝宁' },
  'LFW': { chinese: '洛美', english: 'Lome', country: '多哥' },
  'CON': { chinese: '科纳克里', english: 'Conakry', country: '几内亚' },
  'FNA': { chinese: '弗里敦', english: 'Freetown', country: '塞拉利昂' },
  'ROB': { chinese: '蒙罗维亚', english: 'Monrovia', country: '利比里亚' },
  'BJL': { chinese: '班珠尔', english: 'Banjul', country: '冈比亚' },
  'BXO': { chinese: '比绍', english: 'Bissau', country: '几内亚比绍' },
  'RAI': { chinese: '佛得角', english: 'Praia', country: '佛得角' },

  // 东非
  'NBO': { chinese: '内罗毕', english: 'Nairobi', country: '肯尼亚' },
  'MBA': { chinese: '蒙巴萨', english: 'Mombasa', country: '肯尼亚' },
  'ADD': { chinese: '亚的斯亚贝巴', english: 'Addis Ababa', country: '埃塞俄比亚' },
  'KRT': { chinese: '喀土穆', english: 'Khartoum', country: '苏丹' },
  'JUB': { chinese: '朱巴', english: 'Juba', country: '南苏丹' },
  'DAR': { chinese: '达累斯萨拉姆', english: 'Dar es Salaam', country: '坦桑尼亚' },
  'DOD': { chinese: '多多马', english: 'Dodoma', country: '坦桑尼亚' },
  'JRO': { chinese: '乞力马扎罗', english: 'Kilimanjaro', country: '坦桑尼亚' },
  'EBB': { chinese: '恩德培', english: 'Entebbe', country: '乌干达' },
  'KGL': { chinese: '基加利', english: 'Kigali', country: '卢旺达' },
  'BJM': { chinese: '布琼布拉', english: 'Bujumbura', country: '布隆迪' },
  'ASM': { chinese: '阿斯马拉', english: 'Asmara', country: '厄立特里亚' },
  'JIB': { chinese: '吉布提', english: 'Djibouti', country: '吉布提' },
  'MGQ': { chinese: '摩加迪沙', english: 'Mogadishu', country: '索马里' },
  'HGA': { chinese: '哈尔格萨', english: 'Hargeisa', country: '索马里兰' },

  // 南部非洲
  'JNB': { chinese: '约翰内斯堡', english: 'Johannesburg', country: '南非' },
  'CPT': { chinese: '开普敦', english: 'Cape Town', country: '南非' },
  'DUR': { chinese: '德班', english: 'Durban', country: '南非' },
  'PLZ': { chinese: '伊丽莎白港', english: 'Port Elizabeth', country: '南非' },
  'BFN': { chinese: '布隆方丹', english: 'Bloemfontein', country: '南非' },
  'WDH': { chinese: '温得和克', english: 'Windhoek', country: '纳米比亚' },
  'GBE': { chinese: '哈博罗内', english: 'Gaborone', country: '博茨瓦纳' },
  'MSU': { chinese: '马塞卢', english: 'Maseru', country: '莱索托' },
  'MTS': { chinese: '马普托', english: 'Maputo', country: '莫桑比克' },
  'BEW': { chinese: '贝拉', english: 'Beira', country: '莫桑比克' },
  'MPM': { chinese: '马普托', english: 'Maputo', country: '莫桑比克' },
  'HRE': { chinese: '哈拉雷', english: 'Harare', country: '津巴布韦' },
  'BUQ': { chinese: '布拉瓦约', english: 'Bulawayo', country: '津巴布韦' },
  'LUN': { chinese: '卢萨卡', english: 'Lusaka', country: '赞比亚' },
  'NDL': { chinese: '恩多拉', english: 'Ndola', country: '赞比亚' },
  'LVI': { chinese: '利文斯顿', english: 'Livingstone', country: '赞比亚' },
  'LLW': { chinese: '利隆圭', english: 'Lilongwe', country: '马拉维' },
  'BLZ': { chinese: '布兰太尔', english: 'Blantyre', country: '马拉维' },
  'MRU': { chinese: '路易港', english: 'Port Louis', country: '毛里求斯' },
  'RUN': { chinese: '圣但尼', english: 'Saint Denis', country: '留尼汪' },
  'SEZ': { chinese: '马埃岛', english: 'Mahe', country: '塞舌尔' },
  'TNR': { chinese: '安塔那那利佛', english: 'Antananarivo', country: '马达加斯加' }
};
